...
if rule.nil?
  ...
  CensorRule.create!(:text => regexp,
                     :replacement => '[osobni podaci]',
                     :regexp => true,
                     :last_edit_editor => 'system',
                     :last_edit_comment => 'Created automatically by imamopravoznati-theme #21')

  CensorRule
end

# customized rule for a particular public authority
rules_data = [{:text => 'Vaše ime i adresa / Your name and address: .*$',
               :replacement => 'Vaše ime i adresa / Your name and address: [Adresa]',
               :regexp => true,
